class ServicesController < ApplicationController
  ...
  def service_to_medical_system_params
    params.require(:service_to_medical_system).permit(:image, :name, :address, :establishment, :capacity, :rooms, :phone, :explanation,
                                                      ...
                                                      :disuse_syndrome, :clinical_depression, :schizophrenia, :rheumatism, :osteoporosis, :cerebral_infarction, :myocardial_infarction, :cancer)
